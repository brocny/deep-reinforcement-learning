...
class Network:
    def __init__(self, env, args):
        ...
        self.model.add(tf.keras.layers.Dense(args.hidden_layer, activation = tf.nn.tanh, input_shape = env.state_shape))
...
if __name__ == "__main__":
    ...
    parser.add_argument("--hidden_layer", default=80, type=int, help="Size of hidden layer.")
