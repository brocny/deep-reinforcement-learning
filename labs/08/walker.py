...
if __name__ == "__main__":
    ...
    parser.add_argument("--hidden_layer", default=96, type=int, help="Size of hidden layers.")
    parser.add_argument("--actor_lr", default=2e-4, type=float, help="Learning rate.")
    ...
    while True:
        ...
        if np.mean(returns) - np.std(returns) > 100:
